...
import org.wso2.carbon.apimgt.api.model.FederatedBuilderFactory;
 ...
 */
public class AzureBuilderFactory extends FederatedBuilderFactory<ApiContract> {
     ...
     */
    public AzureBuilderFactory(ApiManagementManager manager, HttpClient httpClient, 
